const data =[
    //who is this for
    {
            ...
            "label_pretty": "Who bought You to the website?",
            "label": "Who bought You to the website?",
            "choices": [{
                    "id": "2.1.1",
                ...
                {
                    "id": "2.1.2",
                    "label": "I am here for a famly member, family, member or someone i care for",
                },
                {
                    "id": "2.1.3",
    ...
    },
    {
        ...
        "label_pretty": "Tell us a little more about the household and who lives there? Does your family member or \
         friend live alone or with others? Check all that apply.",
        "label": "Tell us a little more about the household and who lives there? Does your family member \
        or friend live alone or with others? Check all that apply.",
        "choices": [
            {
                "id": "2.6.1",
                "label": "Alone",
    ...
    //Equity Groups
    {
        ...
        the groups or communities below? Check all that apply.",
        ...
        groups or communities below? Check all that apply.",
        "choices": [
            {
                "id": "2.8.1",
    ...
    },
    {
        ...
        a member of any of the groups or communities below? Check all that apply.",
        "label": "Some supports, services and considerations within this tool are tailored for specific groups’ needs. \
        Is this person a member of any of the groups or communities below? Check all that apply.",
        "choices": [
            {
                "id": "2.9.1",
                "label": "African Nova Scotian",
    ...
    //Geographic Area
    {
        ...
        geographic area of Nova Scotia",
        "label": "My loved one currently lives in and hope to remain in the \
        following geographic area of Nova Scotia",
        "choices": [
            {
                "id": "2.11.1",
                "label": "HRM",
